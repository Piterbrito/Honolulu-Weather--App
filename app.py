...
def welcome():
    ...
    return"""<html>
    <h1>Honolulu, Weather API routes</h1>
    <li>
    List of precipitations ocurred from last year:
    <a href="/api/v1.0/precipitation">/api/v1.0/precipitation</a>
    </li>   
    <li>
    JSON list of the stations: 
   <a href="/api/v1.0/stations">/api/v1.0/stations</a>
   </li>
   
    <li>
    JSON list of Temperature (tobs) for the previous year:
    ...
    <li>
    JSON list of tmin, tmax, tavg for dates in range of start_date and End_date:
